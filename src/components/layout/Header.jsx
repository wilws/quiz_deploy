...
const style = {
  ...
  xl:flex xl:flex-col xl:gap-20  xl:items-center xl:-mt-20 xl:justify-center xl:border-r-2 xl:border-red
  `,

  logo: `w-40 
  md:w-72`,

  title1: `font-sans tracking-wide font-light text-2xl translate-y-2
  ...
  hr: `w-full bg-slate-400 h-0.5`,

  nameWrap: `flex flex-wrap -translate-y-1`,

  myName: `font-sans mr-1 text-sm  pt-1 font-semibold text-slate-500 translate-y-1
  md:text-xl md:translate-y-2`,

  socialIcon: `md:translate-y-2`,

  button: `fixed right-4 top-4 text-normal tracking-tighter bg-black text-white pt-2 pb-2 pl-3 pr-3 cursor-pointer 
